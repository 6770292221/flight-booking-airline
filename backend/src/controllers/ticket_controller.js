...
export async function webhookUpdateTickets(req, res) {
  try {
    ...
    if (ticketStatus === "SUCCESS") {
      ...
      if (user) {
        await axios.post(
          "https://flight-booking-airline.onrender.com/api/v1/payment-core-api/payments/webhook",
          {
...
async function _sendTicketRequest(flight, passengers, bookingNubmer) {
  ...
  const response = await axios.post(
    "https://flight-booking-airline.onrender.com/api/v1/airline-core-api/airlines/ticketing",
    {
      airlineId: airline,
...
export async function requestTicketIssued(req, res) {
  try {
    ...
    await axios.post(
      `https://flight-booking-airline.onrender.com/api/v1/ticket-core-api/webhooks/update-tickets/${booking._id}`,
      reArrange
    );
