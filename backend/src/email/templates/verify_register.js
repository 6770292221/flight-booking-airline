export default function verifyRegisterTemplate({ reqUser }) {
    ...
    const text = `Verify your email address by clicking the link below:\n\nhttps://flight-booking-airline.onrender.com/api/v1/user-core-api/verifyUser/${email}`;
    ...
    <body>
        <div class="container">
            ...
            <div style="text-align: center;">
                <a href="https://flight-booking-airline.onrender.com/api/v1/user-core-api/verifyUser/${email}" class="btn" style="color: #ffffff !important;">Verify Email</a>
            </div>
