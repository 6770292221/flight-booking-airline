...
const FlightJourneyTracker = ({
  ...
  return (
    <div className="flex items-center justify-center mb-8">
      ...
      <div
        data-testid="step-outbound"
        className={`${stepBaseClasses} ${
          selectedOutboundFlight ? "opacity-50" : "text-blue-600"
        }`}
      ...
      >
        <div
          className={`${iconBaseClasses} ${
            selectedOutboundFlight ? "border-gray-400" : "border-blue-600"
          } ${!selectedOutboundFlight && "bg-blue-100"}`}
        >
          <FaPlaneDeparture size={24} />
        </div>
        <span
          className={`${textBaseClasses} ${
            !selectedOutboundFlight && "text-blue-600"
          }`}
        >
          Select Outbound
        </span>
